**Latest Build: 2021-01-24**
+ Update MX Router
+ Feature Vue.JS
+ Feature lodash.js
+ Feature axios.js

![](screenshots/framework_master.png "Framework Master")
## Repository
https://gitlab.com/jodyaryono/framework_master


## Release Version
**Latest Build: 2020-07-05**
+ Fungsi BS3 select

**Latest Build: 2020-07-03**
+ Grocery Crud Custom View render
+ Tampilan query grocery crud bisa dicustomized

**Latest Build: 2020-06-30**
+ Support PHP 7.3 ke atas
+ Grocery Crud Update

## Release Version
**Latest Build: 2019-10-23**
+ konfigurasi menggunakan file fwm_config baik di frontend maupun backend
+ database name terlihat di footer
+ Penambahan fitur Bahasa Indonesia untuk menggunakan cukup memanggil function lang('identifier') , identifier seperti home bisa dilihat di application language/indonesian/general_lang.php
+ Grocery CRUD sudah berbahasa Indonesia untuk menu dan tampilan

**Latest Build: 2019-10-22**

+ Penambahan Media table dan Media class untuk menampilkan gambar


**Latest Build: 2019-09-21**

* [CodeIgniter](http://www.codeigniter.com/) (v3.1.11) - PHP framework
* [Grocery CRUD](http://www.grocerycrud.com/) (v1.6.3) - feature-rich library to build CRUD tables

+ Penambahan Refferensi Datatables
+ Penambahan frontend sample Datatables

### Features

* Update to Allow PHP 7.2.14
...
* **PHP 7.0+**
* **Apache 2.2+** with rewrite mod enabled , open_tags=on
* **MySQL 5.5+** Maria DB

### Setup Guide

1. git clone this repo
2. Create a database (e.g. named "fw-master"), then import /sql/latest.sql into MySQL server
...
application/                    --- Main CodeIgniter source files
    config/
        ...
        fwm_config.php        --- Core configuration file for all sites
...
![](screenshots/frontend_home_new.png "Frontend Home")

Admin Panel - Home:

![](screenshots/admin_home_new.png "Admin Panel Home")
