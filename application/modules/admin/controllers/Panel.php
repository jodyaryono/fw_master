...
class Panel extends Admin_Controller
{
...

	{
		...
		$crud->columns('groups', 'username', 'phone', 'first_name', 'last_name', 'active');

		$this->unset_crud_fields('ip_address', 'last_login');
		$crud->where('username!="webmaster"');
		...
		if ($this->ion_auth->in_group(array('webmaster', 'admin'))) {
			...
			if ($this->ion_auth->in_group(array('admin-surveyor'))) {
				$crud->where('groups', 'surveyor');
				$crud->where('groups', 'admin-surveyor');
			}
		}
