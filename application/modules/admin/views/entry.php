            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header">
                        ...
                        <h3 class="box-title">Ketik NIK:</h3>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <?php if ($jenis == "MUSTAHIK" || $jenis == "SECURITY" || $jenis == "KEBERSIHAN") : ?>

                                <div class="col-md-6 text-center">

                                    <img class="img-responsive" src="<?= REMOTE_URL ?>/assets/uploads/zis/1/foto_ktp/<?= $d['foto_ktp'] ?>" alt="">
