<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.12.35e3c53.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.12.35e3c53' . $minify_or_not . '.js');
