    ...
    RGraph.Fuel = function (conf)
    {
        ...
        this.drawLabels = function ()
        {
            if (!prop.scaleVisible) {
                ...
                // Draw the left label
                var y = this.centery - Math.sin(this.angles.start - RGraph.PI) * (this.radius - 17);
                var x = this.centerx - Math.cos(this.angles.start - RGraph.PI) * (this.radius - 17);
        ...
        this.drawNeedle = function ()
        {
            ...
            this.context.beginPath();
                ...
                this.context.arc(this.centerx, this.centery, this.radius - prop.needleRadiusOffset, angle, angle + 0.0001, false);
        ...
        this.drawScale = function ()
        {
            ...
            if (prop.scaleVisible) {
                ...
                // The labels
                var numLabels  = prop.scaleLabelsCount;
        ...
        {
            // Because this function is called before the short
            ...
            if (this.original_colors.length === 0) {
                ...
                this.original_colors.needleColor = RGraph.arrayClone(prop.needleColor);
            }
            ...
            prop.needleColor = this.parseSingleColorForRadialGradient(prop.needleColor);
        };
