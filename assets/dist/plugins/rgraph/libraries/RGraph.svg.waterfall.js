...
(function (win, doc, undefined)
{
    RGraph.SVG.Waterfall = function (conf)
    {
        ...
        {
            //
            // Allow for property name aliases - this allows for better property
            // names which are more descriptive, make more sense and are more
            // inline with the SVG charts.
            //
            var tmp = RGraph.SVG.propertyNameAlias({object: this, name:  name});
            name    = tmp.name;
