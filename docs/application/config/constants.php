...
define('CI_BOOTSTRAP_REPO',			'https://gitlab.com/jodyaryono/fw_master.git');
define('CI_BOOTSTRAP_VERSION',		'Build 20200401');	// will follow semantic version (e.g. v1.x.x) after first stable launch
